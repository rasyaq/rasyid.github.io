...
![Encoder-Decoder-with-Transformer]({{ BASE_PATH }}/transformers-diagram.JPG "Encoder-Decoder with Transformer")

![Inside-Transformer]({{ BASE_PATH }}/transformers-diagram-depth.JPG "Inside Transformer")
